            ...
            <div class="form-group has-success">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="text" id="merkpensil" name="merkpensil"
                        value="{{ $r->merkpensil }}" placeholder="Masukkan Merk pensil" required>
                </div>
            </div>
            ...
            <div class="form-group has-success">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="number" id="hargapensil" name="hargapensil"
                        value="{{ $r->hargapensil }}" placeholder="Masukkan Harga pensil" required>
                </div>
            </div>
            ...
            <div class="form-group has-success">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="number" step="0.01" id="berat"
                        name="berat" value="{{ $r->berat }}" placeholder="Masukkan Berat pensil (kg)" required>
                </div>
            </div>
