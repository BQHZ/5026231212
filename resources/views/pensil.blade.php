        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="/pensil/edit/{{ $r->ID }}" class="btn btn-sm btn-warning mr-1" title="Edit">
                            Edit
                        </a>
                        <a href="/pensil/hapus/{{ $r->ID }}" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data pensil {{ $r->merkpensil }} ini?')">
                            Hapus
                        </a>
                    </td>
                </tr>
